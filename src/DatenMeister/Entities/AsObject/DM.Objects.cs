namespace DatenMeister.Entities.AsObject.DM
{
    ...
    public class User : DatenMeister.IObject, DatenMeister.DataProvider.IProxyObject
    {
        private DatenMeister.IObject obj;
        public User(DatenMeister.IObject obj)
        {
            this.obj = obj;
        }
        ...
        {
            return factory.create(DatenMeister.Entities.AsObject.DM.Types.User);
        }

        public static User createTyped(DatenMeister.IFactory factory)
        {
            return new User(create(factory));
        }
        ...
        public void setUsername(System.String value)
        {
            setUsername(this, value);
        }

        public static System.String getUsername(DatenMeister.IObject obj)
        {
            var result = obj.get("username", DatenMeister.RequestType.AsSingle);
            return DatenMeister.ObjectConversion.ToString(result);
        }

        public static void setUsername(DatenMeister.IObject obj, System.String value)
        {
            obj.set("username", value);
        }
        ...
        public void setPassword(System.String value)
        {
            setPassword(this, value);
        }

        public static System.String getPassword(DatenMeister.IObject obj)
        {
            var result = obj.get("password", DatenMeister.RequestType.AsSingle);
            return DatenMeister.ObjectConversion.ToString(result);
        }

        public static void setPassword(DatenMeister.IObject obj, System.String value)
        {
            obj.set("password", value);
        }

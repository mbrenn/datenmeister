define(["require", "exports"], function(require, exports) {
    var ExtentOverview = (function () {
        function ExtentOverview() {
        }
        ExtentOverview.prototype.loadTable = function (extentUri) {
            $.get("/api/Extent/Get", { uri: extentUri }).done(function (data) {
                // Clears the table
                $("#extentTable").html("");
        ...
        return ExtentOverview;
    })();
    exports.ExtentOverview = ExtentOverview;
});
